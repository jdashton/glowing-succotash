defmodule Issues.TableFormatter do
  import Enum, only: [ concat: 2, each: 2, join: 2, map: 2, map_join: 3, max: 1 ]
  ...
  Modified to omit the length on the last column to avoid needing trailing
  spaces in our tests.
